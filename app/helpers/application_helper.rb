module ApplicationHelper
  ...
  def check_boxes_for_company_sector(checked, obj, att)
    out = ""
  ...
  def check_boxes_for_member_sector(checked, obj, att)
    out = ""
  ...
  def options_for_member(member = nil)
    members = [ [ "Select the company representative...", "" ] ] + Member.all.map do |member|
  ...
  def options_for_company_type(company_type = nil)
    company_types = [ [ "Select the company type...", "" ] ] + Company.ok_company_types.to_a
  ...
  def options_for_company_size(company_size = nil)
    company_sizes = [ [ "Select the company size...", "" ] ] + Company.ok_company_sizes.to_a
